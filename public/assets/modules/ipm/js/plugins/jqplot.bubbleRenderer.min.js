 ...
 */(function(f){
    ...
    f.jqplot.BubbleRenderer.prototype.init=function(w,t){
        ...
        for(var r=0;r<this.data.length;r++){
            ...
            if(p&&this.bubbleAlpha<1){
                ...
                p="rgba("+n[0]+", "+n[1]+", "+n[2]+", "+this.bubbleAlpha+")"
            }
            if(p){
        ...
        if(this.highlightColors.length==0){
            for(var r=0;r<this.seriesColors.length;r++){
                ...
                this.highlightColors.push("rgba("+u[0]+","+u[1]+","+u[2]+", "+this.highlightAlpha+")")
            }
        }
        this.highlightColorGenerator=new f.jqplot.ColorGenerator(this.highlightColors);
        var m={
            fill:true,
            isarc:true,
    ...
    f.jqplot.BubbleRenderer.prototype.setGridData=function(w){
        ...
        for(var u=0;u<this.data.length;u++){
            if(t[u]!=null){
                this.gridData.push([q.call(this._xaxis,t[u][0]),m.call(this._yaxis,t[u][1]),t[u][2]]);
    ...
    f.jqplot.BubbleRenderer.prototype.makeGridData=function(t,w){
        ...
        for(var u=0;u<t.length;u++){
            if(t[u]!=null){
                x.push([q.call(this._xaxis,t[u][0]),n.call(this._yaxis,t[u][1]),t[u][2]]);
                s.push(t[u][2]);
                this.radii.push([u,t[u][2]])
            }
        }
    ...
    f.jqplot.BubbleRenderer.prototype.draw=function(D,J,n){
        ...
        for(var G=0;G<this.radii.length;G++){
            ...
            this.canvas._elem.append(this.bubbleCanvases[C].createElement(J[0],J[1],E));
            this.bubbleCanvases[C].setContext();
            var D=this.bubbleCanvases[C]._ctx;
            var u=D.canvas.width/2;
            var s=D.canvas.height/2;
            if(this.shadow){
                this.renderer.shadowRenderer.draw(D,[u,s,J[2],0,2*Math.PI],{
                    offset:q,
                    depth:K
                })
            }
            this.bubbleCanvases[C].draw(J[2],F,this.bubbleGradients,this.shadowAngle/180*Math.PI);
    ...
    f.jqplot.DivCanvas.prototype.createElement=function(s,p,n){
        ...
        var o=this._plotDimensions.width-this._offsets.left-this._offsets.right+"px";
        var q=this._plotDimensions.height-this._offsets.top-this._offsets.bottom+"px";
        this._elem=f(r);
        this._elem.css({
            position:"absolute",
            width:o,
    ...
    f.jqplot.BubbleCanvas.prototype.draw=function(m,s,v,p){
        ...
        if(v&&!f.jqplot.use_excanvas){
            ...
            var u="rgba("+Math.round(o[0]+0.8*(255-o[0]))+", "+Math.round(o[1]+0.8*(255-o[1]))+", "+Math.round(o[2]+0.8*(255-o[2]))+", "+o[3]+")";
    ...
    f.jqplot.BubbleAxisRenderer.prototype.init=function(n){
        ...
        var w=q/t;
        var C=I.max-I.min;
        var A=Math.min(this._plotDimensions.width,this._plotDimensions.height);
        var p=o*z/3*C;
        var u=w*F/3*C;
        I.max+=u;
        I.min-=p
    ...
    function e(p,v,q){
        ...
        if(z.labels[q]){
            ...
            p.plugins.bubbleRenderer.highlightLabel.appendTo(p.plugins.bubbleRenderer.highlightLabelCanvas);
            p.plugins.bubbleRenderer.highlightLabel.addClass("jqplot-bubble-label-highlight")
        }
    }
    function i(p){
    ...
    function a(s,p,m,v,r){
        if(v){
            ...
            if(r.series[q[0]].highlightMouseOver&&!(q[0]==r.plugins.bubbleRenderer.highlightedSeriesIndex&&q[1]==r.series[q[0]]._highlightedPoint)){
    ...
    function b(s,p,m,u,r){
        if(u){
            ...
            if(r.series[q[0]].highlightMouseDown&&!(q[0]==r.plugins.bubbleRenderer.highlightedSeriesIndex&&q[1]==r.series[q[0]]._highlightedPoint)){
    ...
    function h(){
        ...
        var n=this._plotDimensions.width-this._gridPadding.left-this._gridPadding.right;
        var m=this._plotDimensions.height-this._gridPadding.top-this._gridPadding.bottom;
