 ...
 */(function(a){
    ...
    a.jqplot.OHLCRenderer.prototype.draw=function(A,N,j){
        ...
        u.tickLength=(s.tickLength!=undefined)?s.tickLength:u.tickLength;
        A.save();
        if(this.show){
            var m,q,g,Q,t;
            ...
            var L=K-l;
            try{
                var P=Math.abs(this._xaxis.series_u2p(parseInt(this._xaxis._intervalStats[0].sortedIntervals[0].interval,10))-this._xaxis.series_u2p(0))
            }catch(H){
                var P=I/L
            }
            if(u.candleStick){
            ...
            for(var D=l;D<K;D++){
                ...
                if(u.candleStick&&!u.hlc){
                    ...
                    if(!u.hlc){
                        u.shapeRenderer.draw(A,[[m-u._tickLength,q],[m,q]],s)
                    }
                    s.color=E;
                    if(u.wickColor){
                        s.color=u.wickColor
                    ...
                    u.shapeRenderer.draw(A,[[m,t],[m+u._tickLength,t]],s);
                    s.color=E
                }
            }
        }
