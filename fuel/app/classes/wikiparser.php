...
class WikiParser {
	...
	public function __construct($analyze=false) {
		$this->patterns=array(
			...
			// Newlines ( make it smarter and so that it groupd paragraphs)
			"/^(?!<li|dd).+(?=(<a|strong|em|img)).+$/mi",			// Ones with breakable elements ( Fix this crap, the li|dd comparison here is just stupid)
