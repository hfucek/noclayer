<?php 
namespace Basic;
class Controller_Kvm_Socket_Set extends Controller_Kvm{
	...
	public function action_index(){
		...
		if($val->run()){
			...
			$socket=Model_Device_Template_Kvm_Socket::find($val->validated('soc'));
			else
			$socket=Model_Device_Kvm_Socket::find($val->validated('soc'));
