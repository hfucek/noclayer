...
class demouser {
    ...
    function demouser() {
        ...
        $this->newuserdata(Sentry::user()->get('id'));
    }
    ...
    private function add_server($pos, $rack, $user, $sw, $macs, $pdu) {
        ...
        $props = array(
            'hostname' => 's' . $pos . '.rck1.fl1.noclayer.com',
            'type' => 0,
            'cat' => 1,
            'rack' => $rack->id,
            'rack_pos' => $pos,
...
//add cabel
    ...
    private function add_switch($rack, $user) {

        $props = array(
            'hostname' => 'switch.noclayer.com',
            'type' => 0,
            'cat' => 2,
            'rack' => $rack->id,
            'rack_pos' => 48,
    ...
    protected function newuserdata($user) {
        ...
        $switch = $this->add_switch($rack, $user);
...
class Controller_Testdemo extends Basic {
