...
<div class="req"><div class="name">Mysql > 5.0</div><div class="alert <?php echo $req['mysql']['class'];?>"><span style="font-size:14px;">(<?php echo $req['mysql']['ver'];?>)</span><?php echo $req['mysql']['value'];?></div></div>
